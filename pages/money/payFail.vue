<template>
	<view class="content">
		...
		<view class="btn-group">
			<navigator url="/pages/order/order?state=0" open-type="redirect" class="mix-btn">去付款</navigator>
			<navigator url="/pages/order/order?state=2" open-type="switchTab" class="mix-btn hollow">查看订单</navigator>
		</view>
	</view>
</template>
